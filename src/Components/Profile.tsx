...
import constructionAnimatie from "../animaties/constructionAnimatie.json";
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#2D4739] text-white text-center p-6">
      <div className="w-72 sm:w-96 mb-6">
        <Lottie animationData={constructionAnimatie} loop={true} />
      </div>
      <h2 className="text-3xl font-bold mb-4">
        We zijn hard aan het werk om deze pagina gebruiksklaar te maken! nog
        even geduld....
      </h2>
